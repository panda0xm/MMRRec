   ...
   and some other features helpful for model training and evaluation.
    ...
    def _train_epoch(self, train_data, epoch_idx, loss_func=None):
        ...
        for batch_idx, interaction in enumerate(train_data):
            ...
            #loss.backward()
            train_losses=losses
            w = self.model.backward(train_losses)
            if w is not None:
               self.batch_weight[:, epoch_idx, batch_idx] = w
    ...
    def fit(self, train_data, valid_data=None, test_data=None, saved=False, verbose=True):
        ...
        """
        self.task_num=self.model.task_num
        self.train_batch_size=2048#118551
        self.model.epoch=0
        
        self.batch_weight = np.zeros([self.task_num, self.epochs, self.train_batch_size])
